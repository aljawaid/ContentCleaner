    ...
    <div class="job-section-wrapper">
        <fieldset class="job-wrapper plugin-job-wrapper">
            <legend class="job-title">
                <span class="content-cleaner-icon"></span> <?= t('%s Plugin', $plugin_job_1) ?>
            ...
            <p class="job-desc">
                <?= t('Remove all traces, content and plugin registration data for %s.', $plugin_job_1) ?>
            ...
            <div class="job-content">
                ...
                <ul class="job-result fa-ul">
                    ...
                    <li class="job-result-text"><?= t('%s will not exist on your system.', $plugin_job_1) ?></li>
                </ul>
            </div>
            <div class="form-actions">
                <a href="<?= $this->url->href('PluginCleaningController', 'confirmRemoval', array('plugin_job_name' => $plugin_job_1, 'job' => '01', 'plugin' => 'ContentCleaner'), false, '', false) ?>" class="btn job-btn js-modal-confirm"><span class="content-cleaner-icon"></span> <?= t('Deep Clean Plugin') ?></a>
            </div>
        </fieldset>
    </div>
